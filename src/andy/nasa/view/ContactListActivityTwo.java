...
import brainvita.twinwaves.hoc.R;
...
public class ContactListActivityTwo extends Activity implements TextWatcher {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		actionBar.setTitle("All Diseases");
		actionBar.setHomeLogo(R.drawable.ic_launcher);
        
		
		filterList = new ArrayList<ContactItemInterface>();
		contactList = Diseases.getSampleContactList();
		...
		protected void onPostExecute(String result) {
			...
			synchronized(searchLock)
			{
				...
				if(inSearchMode){
					...
					ExampleContactAdapter adapter = new ExampleContactAdapter(ContactListActivityTwo.this, R.layout.example_contact_item, filterList);
					adapter.setInSearchMode(true);
					listview.setInSearchMode(true);
					listview.setAdapter(adapter);
				}
				else{
					ExampleContactAdapter adapter = new ExampleContactAdapter(ContactListActivityTwo.this, R.layout.example_contact_item, contactList);
